...
function renderCategories(data) {
  var mainDiv = document.querySelector('.categories-row');
  var odd = true;
  data.forEach(function (element) {
    if (element.enabled) {
      ...
      button.textContent = "Explore ".concat(element.key);
...
function getCarouselItems() {
  ecommService.getBanners().then(function (data) {
    return renderCarousel(data);
...
var sessionStorageService = new _webStorage.default();
var ecommService = new _ecommService.default(); // window.onload = () => getCarouselItems();
