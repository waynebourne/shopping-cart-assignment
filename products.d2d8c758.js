...
},{"../helpers/webStorage":"helpers/webStorage.js"}],"helpers/ecommService.js":[function(require,module,exports) {
"use strict";
...
var EcommService = /*#__PURE__*/function () {
  function EcommService() {
    var url = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'http://localhost:5000/';

    _classCallCheck(this, EcommService);

    this.url = url;
  }

  _createClass(EcommService, [{
    key: "getProducts",
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return fetch("".concat(this.url, "products"));
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return fetch("".concat(this.url, "categories"));
    ...
    key: "getBanners",
    value: function () {
      var _getBanners = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        var data;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return fetch("".concat(this.url, "banners"));
    ...
    key: "addToCart",
    value: function () {
      var _addToCart = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(id) {
        var data;
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return fetch("".concat(this.url, "addToCart/"), {
                  method: 'POST',
                  body: JSON.stringify({
                    productId: id
                  })
...
var _ecommService = _interopRequireDefault(require("../helpers/ecommService"));
...
function getCategories() {
  var data = sessionStorageService.getItem('categories');
...
function getCategoriesFromApi() {
  ecommService.getCategories().then(function (result) {
...
function renderCategories(data) {
  var categoriesPane = document.querySelector('.categories-row');
...
function getProducts() {
  ecommService.getProducts().then(function (data) {
    productsData = data;
    var categorySelected = sessionStorageService.getItem('categorySelected');
...
function renderProducts(data) {
  ...
  data.forEach(function (element) {
    ...
    var priceBuyDiv = document.createElement('div');
    priceBuyDiv.classList.add('flexbox-space-between');
    var priceDiv = document.createElement('div');
    priceDiv.classList.add('mt-1');
    priceDiv.textContent = "MRP Rs. ".concat(element.price);
...
function filterProducts(id) {
  ...
  if (categoryState[id] === -1) {
    var filteredData = productsData.filter(function (x) {
...
window.onbeforeunload = function () {
  return sessionStorageService.removeItem('categorySelected');
};

var sessionStorageService = new _webStorage.default();
var ecommService = new _ecommService.default();
document.addEventListener('DOMContentLoaded', function () {
  getCategories();
  getProducts();
  ...
  shoppingButton.addEventListener('click', _cart.closeCart); // Event delegation

  var categoryRow = document.querySelector('.categories-row');
  ...
  productsRow.addEventListener('click', function (e) {
    if (e.target.tagName === 'BUTTON' && e.target.classList.contains('buy-now')) {
      var button = e.target;
      ecommService.addToCart(button.id).then(function (data) {
        if (data.response === 'Success') {
          // alert(data.responseMessage);
          (0, _cart.setCartCount)(1);
          (0, _cart.setCartItems)(button.id, productsData);
          (0, _cart.renderCartQuantity)();
        } // eslint-disable-next-line no-console
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./cart":"scripts/cart.js","../helpers/webStorage":"helpers/webStorage.js","../helpers/ecommService":"helpers/ecommService.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/products.js"], null)
//# sourceMappingURL=/products.d2d8c758.js.map